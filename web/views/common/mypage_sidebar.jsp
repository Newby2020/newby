...
<div class="sidenavsk">
    ...
    <a href="mypage_Profile.jsp">프로필</a>
    <a href="mypage_Mileage.jsp">마일리지</a>
    <a href="mypage_ClassSchedule.jsp">수강예정 클래스</a>
    <a href="mypage_PaymentPage.jsp">결제 내역</a>
    <a href="mypage_WritingReview1.jsp">후기 작성</a>
