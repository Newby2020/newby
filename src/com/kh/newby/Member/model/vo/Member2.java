...
public class Member2 implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 32964755710101469L;
	/**
	 * 
	 */
	private String m_no;
	...
	private String h_no;
	private int userClassCount;
	
	public Member2() {
		
	}

	public Member2(String m_no, String m_id, String m_nick, String m_pwd, String m_name, String m_phone,
	...
	public Member2(String m_id, String m_pwd) {
		super();
		this.m_id=m_id;
		this.m_pwd=m_pwd;
	}

	public Member2(String m_id, String m_pwd, String m_nick, String m_name, String m_phone) {
		super();
		this.m_id = m_id;
		this.m_nick = m_nick;
		this.m_pwd = m_pwd;
	...
	public void setUserClassCount(int userClassCount) {
	...
	public String toString() {
		return "Member [m_no=" + m_no + ", m_id=" + m_id + ", m_nick=" + m_nick + ", m_pwd=" + m_pwd + ", m_name="
				...
				+ ", h_no=" + h_no + ", userClassCount=" + userClassCount + "]";
	}	
}
